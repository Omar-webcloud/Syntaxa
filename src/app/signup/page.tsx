         ...
         <div className="bg-white dark:bg-[#1C1625] p-8 rounded-[32px] shadow-xl border border-gray-100 dark:border-[#2D2438] space-y-6 transition-colors duration-300">
             <form onSubmit={handleSubmit} className="space-y-4">
                 ...
                 <button 
                    ...
                    disabled={loading}
                    className={cn(
                        "w-full py-4 bg-[#111] dark:bg-white text-white dark:text-black rounded-2xl font-black shadow-lg hover:opacity-90 active:scale-[0.98] transition-all flex items-center justify-center gap-2 mt-4",
